...
document.body.style.cursor = 'none';
    ...
    const Cursor = (() => {
        ...
        const handlePointerEnter = (e) => {
            ...
            if ( pointerType == 'hover' ) {
                ...
                gsap.to(cursorSmall, { scale: 0.5, opacity: 1, duration: 0.3 });
    
            }
            else if ( pointerType == 'input' ) {
    
                gsap.to(cursorLarge, { scale: 0, opacity: 1, duration: 0.3 });
                gsap.to(cursorSmall, { scaleX: 0.2, scaleY: 2.5, opacity: 1, duration: 0.3 });
    ...
    document.addEventListener('click', function(event) {
        ...
        if (event.target.tagName.toLowerCase() === 'input') {
            ...
            gsap.to(cursorSmall, { scaleX: 0.2, scaleY: 1.2, opacity: 1, duration: 0.2 });
    
            setTimeout(() => {
                gsap.to(cursorSmall, { scaleX: 0.2, scaleY: 2.5, opacity: 1, duration: 0.2 });
            }, 200); 
            ...
            gsap.to(cursorLarge, { scale: 0, opacity: 1, duration: 0.2 });
    
            setTimeout(() => {
                gsap.to(cursorLarge, { scale: 2, opacity: 1, duration: 0.2 });
            }, 200); 
            ...
            setTimeout(() => {
                gsap.to(cursorLarge, { scale: 1, opacity: 1, duration: 0.2 });
            }, 200); 
        }
